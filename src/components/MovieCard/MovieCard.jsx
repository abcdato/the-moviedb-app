...
const MovieCard = ({ title, releaseDate, overview, posterPath, genreIds, genreList }) => {
  ...
  const date = releaseDate ? format(new Date(releaseDate), 'MMMM d, yyyy') : null;
  ...
  return (
    <li className="movie-card card">
      ...
      <div className="card__properties">
        ...
        <div className="card__genres">{genreIds ? <Genres genreIds={genreIds} genreList={genreList} /> : null}</div>
